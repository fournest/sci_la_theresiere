 ...
 */
final class Version20250829074645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE user_id user_id INT DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE visite CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite CHANGE user_id user_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE user_id user_id INT NOT NULL, CHANGE categorie_id categorie_id INT NOT NULL');
    }
}
